...
if ( ! class_exists( 'udtbp_Public' ) ) :
  class udtbp_Public {
    ...
    */
     ...
     * @since    3.0.0
     * @access   private
     * @var      string    $current_theme    The current active theme.
     */
  ...
  */
    ...
    */
     ...
     *
     * @since     3.0.0
     * @return    boolean   If TRUE, add fav icons
    ...
    public function udt_add_favicon() {
      ...
      // echo sprintf( $notice_div
      $meta_tags = [
        sprintf( '<link rel="icon" href="%s" sizes="32x32">', esc_url( get_site_icon_url( 32 ) ) ),
        sprintf( '<link rel="icon" href="%s" sizes="192x192">', esc_url( get_site_icon_url( 192 ) ) ),
        sprintf( '<link rel="apple-icon-precomposed" href="%s">', esc_url( get_site_icon_url( 180 ) ) ),
    ...
    /**
	   * REMOVE WP HEAD BLOAT
	   * Removes unnecessary <head> bloat added by WordPress.
	   * all actions related to emojis
	   *
	   * @see   			emoji_svg_url               removes TinyMCE emojis
	   * @see   			tiny_mce_plugins            removes DNS prefetch
	   * @see   			disable_emojicons_tinymce   disables TinyMCE emojicons
	   * @since       3.1.0
	   * @link         http://geoffgraham.me/wordpress-how-to-clean-up-the-header/
	   * @link         http://www.springboardseo.com/seo-blog/technical/remove-wordpress-code-bloat-header/
	   */
    /**
     * DISABLE EMOJICONS
     * function that defines actions and filters used to disable emojicons.
     *
     * @since  3.1.0
     */
		   ...
		   * function used to disable TinyMCE emojicons.
		   *
		   * @since  3.1.0
		   */
	  	...
	  	/**
	  	* INITIALIZE HEAD CLEANUP
	  	* @since   3.1.0
	  	*/
	  	function wp_head_cleaner() {
   ...
   *
   * @since     3.0.0
   * @version   1.1     Added minify css php
   * @return    null    Return early if no settings page is registered.
  */
    public function enqueue_styles() {
      ...
      if ( isset( $options ) && !empty( $options ) ) {
        ...
        wp_register_style( $this->udtbp .'-public-styles', UDTBP_PUBLIC_CSS_URL.'/minify.css.php', array(), UDTBP_VERSION, 'all' );
    ...
    */
    ...
    public function udtbp_enqueue_inline_theme_styles() {
      ...
      if ( in_array( $this->current_theme, $json_theme_list ) ) :
?>
...
<img alt="University of Delaware" id="ud_primary_logo_big" width="218" height="91" src="{$const_public_image}/logo-udel.png">
</a>$show_custom_text
</div>
</div>
</header>
    ...
    */
    public function front_end_footer() {
      ...
      if( isset( $options["view-footer"] ) && $options["view-footer"] != 0  ):
        include_once ( UDTBP_PUBLIC_VIEWS_URL . 'udtbp-public-footer-display.php' );
      endif;
    }
