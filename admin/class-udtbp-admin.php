...
if ( ! class_exists( 'udtbp_Admin' ) ) :
  ...
  */
   ...
   * @param      string           $current_theme     The active theme.
	*/
   ...
   * @todo            Remove inline styles and concatenate to admin stylesheet.
	*/
     ...
     * @param       string      $screen    Used to get the name of the screen that the current user is on.
     * @return      null                   Return early if no settings page is registered.
     * @uses        Font Awesome CDN, jQuery Form, jQuery UI Dialog, jQuery UI Tabs, jQuery UI Widget scripts
    */
    ...
    */
    ...
    ?>
        <li class="ui-state-default <?php echo esc_html( $active ); ?>" role="presentation"><a class="aria_selected ui-tabs-anchor" aria-selected="<?php echo esc_html( $aria_selected ); ?>" role="tab" aria-controls="udt_<?php echo esc_html( $tab_key ); ?>_settings" href="?page=<?php echo esc_html($this->udtbp );?>&tab=<?php echo esc_html($tab_key ); ?>"> <?php echo esc_html( $tab_caption ); ?></a></li>
    <?php
      }
    ?>
      </ul>
<?php
  ...
  public function add_settings_link( $actions, $plugin_file ) {
    static $plugin;
        ...
        $site_link = array( 'support' => '<a title="Submit a Help Request" target="_blank" href="//www.udel.edu/it/help/request/">' . __( 'Support', $this->udtbp ) . '</a>' );
  ...
  * Callback function for the admin settings page.
	...
	*/
	 public function display_plugin_admin_page(){
	  include_once ( plugin_dir_path( dirname( __FILE__ ) ) . 'admin/views/udtbp-admin-display.php' );
